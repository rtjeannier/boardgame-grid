...
// fully covered (1.0) at the rim. Two polygons tell the anchoring story —
// what your anchors already cover, and what the filled collection covers.
export default function Radar({ dimensions, anchorCoverage, fullCoverage, hasAnchors }) {
  ...
  return (
    <svg className="radar" viewBox="0 0 1 1">
      ...
      <polygon points={polygon(fullCoverage)} className="radar__full" />
      {hasAnchors && <polygon points={polygon(anchorCoverage)} className="radar__anchor" />}
